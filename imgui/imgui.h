...
//  ============== this seems to be reduplicated definitions =================
...
#ifndef IMGUI_API
// #define IMGUI_API __declspec(dllexport)   // If you are building a DLL, change to __declspec(dllexport). If you are using a DLL, change to __declspec(dllimport).
#define IMGUI_API
#endif
