...
#define LOG_DEBUG(msg) RYRayTracing::Logger::debug(msg, __FILE__, __LINE__)
#define LOG_INFO(msg) RYRayTracing::Logger::info(msg, __FILE__, __LINE__)
#define LOG_WARNING(msg) RYRayTracing::Logger::warning(msg, __FILE__, __LINE__)
#define LOG_ERROR(msg) RYRayTracing::Logger::error(msg, __FILE__, __LINE__)
#define LOG_FATAL(msg) RYRayTracing::Logger::fatal(msg, __FILE__, __LINE__)
